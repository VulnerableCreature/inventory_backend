...
use App\Module\RoomOccupant\DTO\RemoveOccupantDto;
use App\Module\RoomOccupant\Exceptions\InvalidOccupantDataException;
use Illuminate\Contracts\Validation\ValidationRule;
use Illuminate\Foundation\Http\FormRequest;

final class RemoveOccupantRequest extends FormRequest
{
    /**
     ...
     */
    public function toDto(): RemoveOccupantDto
    {
        return RemoveOccupantDto::fromRequest($this->validated());
    }
}
